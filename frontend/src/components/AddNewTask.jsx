...
const AddNewTask = ({ isOpen, onClose, onAddTask }) => {
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-3 bg-gray-700 border-2 border-gray-600 rounded-xl text-gray-100 placeholder-gray-400 focus:border-gray-500 focus:ring-2 focus:ring-gray-600 outline-none transition-all duration-200"
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows="3"
              className="w-full px-4 py-3 bg-gray-700 border-2 border-gray-600 rounded-xl text-gray-100 placeholder-gray-400 focus:border-gray-500 focus:ring-2 focus:ring-gray-600 outline-none transition-all duration-200 resize-none"
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-3 bg-gray-700 border-2 border-gray-600 rounded-xl text-gray-100 focus:border-gray-500 focus:ring-2 focus:ring-gray-600 outline-none transition-all duration-200"
              >
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              className="flex-1 px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-500 hover:from-gray-500 hover:to-gray-400 text-white font-semibold rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl"
            >
              Add Task
            </button>
          </div>
